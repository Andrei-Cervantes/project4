            ...
            <div className='contact-info-container justify-center justify-md-space-between'>
                ...
                <div className='contacts'>
                    <div className='d-flex flex-row gap-2'>
                        <img src={phone} alt="Phone" style={{ width: 'auto', height: 'auto', maxWidth: '32px', maxHeight: '32px' }} />
                        <div>
                            <p>(0912) 345 6789</p>
                            <p>(02) 123 4567</p>  
                        </div> 
                    ...
                    <div className='d-flex flex-row gap-2'>
                        <img src={email} alt="Email" style={{ width: 'auto', height: 'auto', maxWidth: '32px', maxHeight: '32px' }} />
                        <p>samplesalesemail@gmail.com</p>
                    </div>
                    <div className='d-flex flex-row gap-2'>
                        <img src={facebook} alt="Facebook" style={{ width: 'auto', height: 'auto', maxWidth: '32px', maxHeight: '32px' }} />
